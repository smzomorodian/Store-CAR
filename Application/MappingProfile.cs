...
namespace Carproject
{
    ...
    public class MappingProfile : Profile
    {
        ...
        public MappingProfile()
        {
            ...
            CreateMap<CommanCustomer, Customer>().ReverseMap();  // تبدیل از RegisterCustomerModel به Customer
            CreateMap<Customer, CustomerDto>().ReverseMap()
            .ForMember(dest => dest.LoyaltyStatus, opt => opt.MapFrom(src => src.LoyaltyStatus.ToString())); //Enum عدد به رشته 
